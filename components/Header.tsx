    ...
    return (
        <div className="max-w-6xl mx-auto p-2"> 
            ...
            <section className="flex items-center space-x-2 py-5">
                <div className="h-16 w-16 sm:w-28 md:w-44 cursor-pointer flex-shrink-0"> {/* cela signifie que l'élément ne peut pas se rapetisser pour s'adapter à l'espace disponible dans son conteneur */} 
                    <Link href="/">
                        <Image 
                            className="h-full w-full object-contain" // object-contain is the same as object-fit: contain / permet de ne pas déformer l'objet
                            alt="Ebay Logo" 
                            src={EbayLogo}
                            width={100}
                            height={100}
